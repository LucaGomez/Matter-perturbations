...
#nets = [FCNN(n_input_units=2,  hidden_units=(256,128,64,), actv=nn.Tanh,) for _ in range(2)]

nets = [CustomNN(n_input_units=2, hidden_units= (256, 128, 64), actv = nn.SiLU, n_output_units = 1) for _ in range(2)]
#nn.SiLU
...
plt.savefig('loss_silu_silu_custom.png')

# Save the neural network:
torch.save(solver._get_internal_variables()['best_nets'], 'nets_LCDM_silu_custom.ph')