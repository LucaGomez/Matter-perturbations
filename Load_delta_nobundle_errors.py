# -*- coding: utf-8 -*-
"""
Created on Tue Oct 31 18:04:52 2023
...
# Load the networks:
nets = torch.load('nets_LCDM_tanh_custom_nb.ph',
...
plt.plot(N, delta_p_nn,label=r'$\delta_p$ NN')
plt.plot(N, delta_p_num,label=r'$\delta_p$ Num')
...
plt.plot(a,dif_rel,label=r'$\delta$')
plt.plot(a,dif_rel_p,label=r'$\frac{d\delta_m}{da}$')
plt.xscale('log')
plt.xlabel('a')
plt.ylabel('err%')
plt.legend()
plt.savefig('errptanhcustnb.png')
